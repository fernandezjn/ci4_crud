<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-5">
                <h5 class="card-header fw-bold">Add New Student</h5>
                <div class="card-body">
                    <form method="post" action="<?php echo site_url('crud/save'); ?>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="student_number" class="form-control" id="student_number" name="student_number" placeholder="Student Number" required>
                        </div>
